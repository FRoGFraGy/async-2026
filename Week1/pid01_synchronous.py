...
def make_coffee(customer_name):
    ...
    sleep(5)  # จำลองการทำงานของ Thread ไว้ 5 วินาที
...
def main():
    ...
    print(f"{ctime()} | [Main PID: {main_pid}] [Main TID: {main_tid}] === เริ่มระบบชงกาแฟแบบ Synchronous ===")
    start_time = time()

    # ชงทีละงานตามลำดับคิวเดียว (ทีละคน)
